                                    ...
                                    <div class="panel-body">
                                        <table id="datatable" class="table responsive-data-table table-striped">
                                            ...
                                            <tr>
                                                ...
                                                <td>@if($bl->event) {{$bl->event->title}} @endif </td>
                                                @if($bl->status==ACTIVE)
        ...
        <div class="modal-content">
            ...
            <div class="form">
                        ...
                        <div class="form-group">
                            <label for="project_id" class="control-label col-lg-3">Event</label>
                            <div class="col-lg-9">
                                <select class=" form-control" name="project_id">
                                <option disabled selected>Select option</option>
                                @foreach($events as $ch)
...
$('#new-form').submit(function(e){
    ...
    function update(event){
        ...
        $('#editproject_id').val(event.event_id)
        $('#editid').val(event.id)
